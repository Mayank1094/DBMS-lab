create table publisher13 (name varchar2(20) primary key, address varchar2(20), phone number(10));
...
create table book13 (book_id int primary key, title varchar2(15), publisher_name varchar2(20) references publisher13(name), pub_year int);
...
create table bookauthor13 (book_id int references book13(book_id) on delete cascade, author_name varchar2(15));
...
create table librarybranch13 (branch_id int primary key, branch_name varchar2(20), address varchar2(20));
...
create table bookcopies13 (
    book_id int references book13(book_id) on delete cascade,
    branch_id int references librarybranch13(branch_id) on delete cascade,
    no_of_copies int,
...
select b.book_id, b.title, 
       ...
       c.branch_id 
from book13 b
join bookauthor13 a on b.book_id = a.book_id
join bookcopies13 c on b.book_id = c.book_id
join librarybranch13 l on l.branch_id = c.branch_id;
...
create view available_books13 as 
select b.book_id, b.title, bc.no_of_copies, ba.author_name 
from book13 b 
join bookauthor13 ba on b.book_id = ba.book_id 
join bookcopies13 bc on b.book_id = bc.book_id 
