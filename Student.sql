...
select sum(marks1) from student01 where class='b';

select avg(marks2) from student01;

select count(*) from student01 where class = 'a';

select * from student01 where name like '%k%';

select regno, name, class, bdate, marks3 from student01 where marks3 between 75 and 90;
